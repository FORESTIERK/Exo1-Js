/* votre fonction ici*/
function parag1(){
		document.getElementById('parag1').style.background = "black";
		...
		document.getElementById('fond').style.background ="gray";
		...
		document.getElementById('bouton').style.borderWidth = "2px";
		document.getElementById('fond').src = "img.jpg";
}